...
export default function Hero() {
  ...
  return (
    <header id="top" className="relative min-h-screen pb-16 pt-[100px]">
      <div
        className={`mx-auto grid max-w-[1180px] items-center gap-14 px-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-[60px] ${
      ...
      >
        <div>
          {/* Availability */}
          <div
            className={`mb-6 inline-flex items-center gap-2 rounded-full border border-amber/25 bg-amber/[0.14] px-3 py-1.5 font-mono text-[0.78rem] text-amber ${
